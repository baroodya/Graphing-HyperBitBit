...
class ExperimentLauncherTest {
    private final ExperimentLauncher launcher;
    ...
    void arithmeticMean() {
        double[] values = new double[100];
        for (int i = 0; i < 100; i++) values[i] = 4;
        assert launcher.arithmeticMean(values) == 4;

        values = new double[10000];
        for (int i = 0; i < 10000; i++) values[i] = 99574.0;
        assert launcher.arithmeticMean(values) == 99574.0;

        values = new double[]{1, 1, 1, 1, 3, 3, 3, 3};
        assert launcher.arithmeticMean(values) == 2;
        ...
        assert launcher.arithmeticMean(values) == 546586661;
        ...
        assert Math.round(launcher.getStdDev(values)) == 535098569.0;
    }
}
