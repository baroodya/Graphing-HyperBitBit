...
public class ComparisonGenerator {
    ...
    protected final main.ComparisonLauncher launcher; // The launcher we will get the data from
...
//    private final Axis normalizedErrorYAxis = Axis.builder().fixedRange(true).range(-1.5, 1.5).build();
    ...
    public ComparisonGenerator(main.ComparisonLauncher launcher) {
