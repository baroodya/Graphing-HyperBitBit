...
public class BasicGrapherTest {
  ...
  public BasicGrapherTest() {
    ...
    DoubleColumn someOtherColumn_Size10 =
        DoubleColumn.create("someOtherArray_Size10", someOtherArray_Size10);
    DoubleColumn someThirdColumn_Size10 =
        DoubleColumn.create("someThirdArray_Size10", someThirdArray_Size10);
    ...
    DoubleColumn someOtherColumn_Size20 =
        DoubleColumn.create("someOtherArray_Size20", someOtherArray_Size10);
    ...
    someTable_Size3X10 =
        Table.create(
            "someTable_Size3X10", someColumn_Size20, someOtherColumn_Size20, someLabelColumn);
  ...
  public void createTable() {
    ...
    output =
        grapher.createTable(
            ...
            "someArray_Size20",
            someArray_Size10,
            "someOtherArray_Size20",
            "label",
            someOtherArray_Size10,
            "label",
            someThirdArray_Size10);
  ...
  public void showLinePlot() {
    ...
    grapher.showLinePlot(title, someTable_Size3X10);
  ...
  public void showScatterPlot() {
    ...
    grapher.showScatterPlot(title, someTable_Size3X10);
    assert grapher.columns.equals(someTable_Size3X10.columnNames());
  }
